        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val gasGalonDeferred = async { 
                    try { RetrofitClient.instance.getGasGalon().data } catch (e: Exception) { emptyList() }
                }
                val laundryDeferred = async { 
                    try { RetrofitClient.instance.getLaundry().data } catch (e: Exception) { emptyList() }
                }
                val cleaningDeferred = async { 
                    try { RetrofitClient.instance.getCleaning().data } catch (e: Exception) { emptyList() }
                }
