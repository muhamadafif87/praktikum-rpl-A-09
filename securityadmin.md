...
<section>
<header class="mb-stack-md mt-2"><h1 class="text-headline-lg font-headline-lg text-on-surface mb-1">Keamanan &amp; Log Akses</h1><p class="text-body-md text-on-surface-variant">Pemantauan aktivitas sistem dan audit keamanan real-time.</p></header>
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter mb-stack-lg"><div class="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary transition-colors flex flex-col justify-between"><div class="flex justify-between items-start"><span class="text-label-md font-label-md text-on-surface-variant mb-2">Up-time Sistem</span><span class="material-symbols-outlined text-primary">timer</span></div><div class="text-headline-lg font-headline-lg text-on-surface font-bold">99.9%</div><div class="text-label-sm font-label-sm text-on-surface-variant mt-2">Operasional normal</div></div><div class="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-error transition-colors flex flex-col justify-between"><div class="flex justify-between items-start"><span class="text-label-md font-label-md text-on-surface-variant mb-2">Upaya Login Gagal</span><span class="material-symbols-outlined text-error">login</span></div><div class="text-headline-lg font-headline-lg text-on-surface font-bold">12</div><div class="text-label-sm font-label-sm text-error mt-2">24 jam terakhir</div></div><div class="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary transition-colors flex flex-col justify-between"><div class="flex justify-between items-start"><span class="text-label-md font-label-md text-on-surface-variant mb-2">Peringatan Keamanan</span><span class="material-symbols-outlined text-primary">gpp_good</span></div><div class="text-headline-lg font-headline-lg text-on-surface font-bold">0</div><div class="text-label-sm font-label-sm text-primary mt-2">Sistem aman</div></div><div class="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary transition-colors flex flex-col justify-between"><div class="flex justify-between items-start"><span class="text-label-md font-label-md text-on-surface-variant mb-2">Sertifikat SSL</span><span class="material-symbols-outlined text-tertiary">workspace_premium</span></div><div class="text-headline-lg font-headline-lg text-on-surface font-bold">Aktif</div><div class="text-label-sm font-label-sm text-tertiary mt-2">Expired dlm 120 hari</div></div></div>
</section>
<section class="bg-surface-container-lowest rounded-xl border border-outline-variant overflow-hidden flex flex-col"><div class="p-6 border-b border-outline-variant flex flex-col md:flex-row justify-between items-start md:items-center gap-4"><h2 class="text-headline-sm font-headline-sm text-on-surface font-bold">Log Aktivitas Keamanan</h2><div class="flex flex-wrap gap-3"><div class="relative"><span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant text-sm">search</span><input class="bg-surface-container-low border border-outline-variant rounded-lg pl-9 pr-4 py-2 text-label-md focus:ring-1 focus:ring-primary outline-none w-48" placeholder="Cari log..." type="text"></div><button class="flex items-center gap-2 bg-surface-container-low border border-outline-variant rounded-lg px-4 py-2 text-label-md hover:bg-surface-container-high transition-colors"><span class="material-symbols-outlined text-sm">calendar_today</span> Rentang Waktu</button></div></div><div class="overflow-x-auto"><table class="w-full text-left border-collapse"><thead><tr class="bg-surface-container-low text-label-sm font-label-sm text-on-surface-variant border-b border-outline-variant"><th class="p-4 font-medium">Waktu</th><th class="p-4 font-medium">Pengguna</th><th class="p-4 font-medium">Aktivitas</th><th class="p-4 font-medium">Alamat IP</th><th class="p-4 font-medium text-right">Status</th></tr></thead><tbody class="text-body-sm font-body-sm text-on-surface divide-y divide-outline-variant/30"><tr class="hover:bg-surface-bright transition-colors"><td class="p-4">10:45:22</td><td class="p-4 font-medium">Admin Central</td><td class="p-4">Sistem Login Sukses</td><td class="p-4 text-on-surface-variant">192.168.1.45</td><td class="p-4 text-right"><span class="bg-surface-container-highest text-on-surface px-2.5 py-1 rounded-full text-label-sm font-medium">Berhasil</span></td></tr><tr class="hover:bg-surface-bright transition-colors"><td class="p-4">10:30:15</td><td class="p-4 font-medium">System Admin</td><td class="p-4">Update Partner Status (Kost Amanah)</td><td class="p-4 text-on-surface-variant">192.168.1.12</td><td class="p-4 text-right"><span class="bg-surface-container-highest text-on-surface px-2.5 py-1 rounded-full text-label-sm font-medium">Berhasil</span></td></tr><tr class="hover:bg-surface-bright transition-colors"><td class="p-4">09:12:05</td><td class="p-4 font-medium">Security Bot</td><td class="p-4">Deteksi Login Gagal (3x)</td><td class="p-4 text-on-surface-variant">103.25.11.2</td><td class="p-4 text-right"><span class="bg-error-container text-on-error-container px-2.5 py-1 rounded-full text-label-sm font-medium">Terblokir</span></td></tr><tr class="hover:bg-surface-bright transition-colors"><td class="p-4">08:45:10</td><td class="p-4 font-medium">Manager HQ</td><td class="p-4">Password Change Requested</td><td class="p-4 text-on-surface-variant">192.168.1.88</td><td class="p-4 text-right"><span class="bg-surface-container-highest text-on-surface px-2.5 py-1 rounded-full text-label-sm font-medium">Menunggu</span></td></tr></tbody></table></div></section><section class="bg-surface-container-lowest rounded-xl border border-outline-variant overflow-hidden flex flex-col mt-stack-lg">
...
<h2 class="text-headline-sm font-headline-sm text-on-surface font-bold">Manajemen Role &amp; Izin Akses</h2>
<button class="flex items-center gap-2 bg-primary text-white rounded-lg px-4 py-2 text-label-md hover:bg-primary-container transition-colors">
...
<thead>
<tr class="bg-surface-container-low text-label-sm font-label-sm text-on-surface-variant border-b border-outline-variant">
<th class="p-4 font-medium">User/Role</th>
<th class="p-4 font-medium">Izin Akses (Permissions)</th>
<th class="p-4 font-medium">Terakhir Aktif</th>
...
<span class="text-label-sm text-on-surface-variant">Root Access</span>
</div>
</td>
<td class="p-4">
<div class="flex flex-wrap gap-1">
<span class="bg-surface-container-high text-on-surface px-2 py-0.5 rounded text-[10px] font-medium">Full Access</span>
<span class="bg-surface-container-high text-on-surface px-2 py-0.5 rounded text-[10px] font-medium">System Config</span>
</div>
</td>
<td class="p-4 text-on-surface-variant">Sekarang</td>
<td class="p-4 text-right">
<button class="text-primary hover:underline text-label-sm font-medium">Edit Permissions</button>
</td>
</tr>
<tr class="hover:bg-surface-bright transition-colors">
<td class="p-4">
<div class="flex flex-col">
<span class="font-medium">Finance Manager</span>
<span class="text-label-sm text-on-surface-variant">Financial Dept</span>
</div>
</td>
<td class="p-4">
<div class="flex flex-wrap gap-1">
<span class="bg-surface-container-high text-on-surface px-2 py-0.5 rounded text-[10px] font-medium">View Reports</span>
<span class="bg-surface-container-high text-on-surface px-2 py-0.5 rounded text-[10px] font-medium">Manage Payments</span>
</div>
</td>
<td class="p-4 text-on-surface-variant">2 jam yang lalu</td>
<td class="p-4 text-right">
<button class="text-primary hover:underline text-label-sm font-medium">Edit Permissions</button>
</td>
</tr>
...
<td class="p-4">
<div class="flex flex-col">
<span class="font-medium">Security Auditor</span>
<span class="text-label-sm text-on-surface-variant">Compliance Team</span>
</div>
</td>
<td class="p-4">
<div class="flex flex-wrap gap-1">
<span class="bg-surface-container-high text-on-surface px-2 py-0.5 rounded text-[10px] font-medium">View Only</span>
<span class="bg-surface-container-high text-on-surface px-2 py-0.5 rounded text-[10px] font-medium">Audit Logs</span>
</div>
</td>
<td class="p-4 text-on-surface-variant">Kemarin, 14:20</td>
<td class="p-4 text-right">
<button class="text-primary hover:underline text-label-sm font-medium">Edit Permissions</button>
</td>
</tr>
