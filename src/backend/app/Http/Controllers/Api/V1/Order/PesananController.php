...
class PesananController extends Controller {
    ...
    // -------------------------------------------------------------------------
    // MOCK PAYMENT /landing-page/pesanan/{id}/mock-payment
    // -------------------------------------------------------------------------
    public function mockPayment(Request $request, string $idUniquePesanan): JsonResponse
    {
        try {
            /** @var \App\Models\User $user */
            $user = $request->user();

            $data = $this->PesananService->mockPayment(
                idUniquePesanan: $idUniquePesanan,
                idUser:          (string) $user->id_user
            );
